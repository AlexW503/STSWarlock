...
public class FuturePlans extends AbstractRitual {
    /*
    * R Skill
    * 1E
    * Shuffle 3(4) energy nodes into deck
    ...
    public static final String IMG = RitualistMod.makePath("customImages/future.png");
    ...
    public FuturePlans() {
        ...
        cardsToPreview = new UN_EnergyGem();
        exhaust = true;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new MakeTempCardInDrawPileAction(card, magicNumber, true, true));
    }
