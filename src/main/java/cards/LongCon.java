...
public class LongCon extends CustomCard {
    ...
    * Gain 5 block. In two turns gain [G] [G].
    ...
    public static final String IMG = RitualistMod.makePath("customImages/long.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new ApplyEnergizedPower(p, magicNumber), magicNumber));
    }
