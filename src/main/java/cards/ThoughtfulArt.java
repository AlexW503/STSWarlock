...
public class ThoughtfulArt extends AbstractRitual {
    ...
    * UNC Skill
    * 0E Ritual
    * Ritual Gain 2 block. If you played more than 5 cards this turn draw a card and gain 3 more block.
     */
    ...
    public static final String IMG = RitualistMod.makePath("customImages/art.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ThoughtfulArtAction(magicNumber, block));
